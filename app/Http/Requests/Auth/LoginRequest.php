...
class LoginRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        FILTER_VALIDATE_EMAIL) ? 'email' : 'login_id';
    ...
    {
        return [
            'email' => ['required_without:login_id','string','email','exists:users,email'],
            'login_id' => ['required_without:email','string','exists:users,login_id'],
